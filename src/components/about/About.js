          ...
          <div className='flex-1 w-full'>
            ...
            {activeOption === 'brief' && 
              <div className='w-full flex flex-col mt-[3rem] mb-[5rem] text-[color:var(--color-light)] gap-[1rem] text-justify'>
                ...
                <p>I graduated from Banking Academy, but I'm very interested in coding when learning about that. Currently, I am studying international development at FPT APTECH center. In addition, through self-study, I honed my skills in front-end web development.</p>
