...
function Header({toggleChangeLanguage, language}) {
  ...
  return (
    <header
      id="header"
      className=" lg:w-[length:var(--container-width-lg)] md:w-[length:var(--container-width-md)] sm:w-[length:var(--container-width-sm)] w-[length:var(--container-width-sm)] h-screen text-center pt-[7rem] overflow-hidden mx-auto relative min-h-[800px]" >
      {language === 'English' &&
      <>
